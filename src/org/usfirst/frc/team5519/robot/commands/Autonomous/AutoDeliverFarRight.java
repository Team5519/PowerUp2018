 ...
 *
 */
public class AutoDeliverFarRight extends CommandGroup {

    public AutoDeliverFarRight() {
        // Add Commands here:
        ...
        // arm.
    	addSequential(new AutoDriveStraightDistance(200));
    	addSequential(new AutoTurnRight(90));
    	addSequential(new AutoDriveStraightDistance(225));
    	addSequential(new AutoTurnRight(90));
