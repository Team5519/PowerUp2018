 ...
 *
 */
public class AutoRightPushBoxes extends CommandGroup {

    public AutoRightPushBoxes(int startside) {
        // Add Commands here:
    	...
    	addSequential(new AutoTurnLeft(RobotMap.START_POSITION_RIGHT));
    }
}
